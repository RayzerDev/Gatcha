...
public class PlayerService {
    ...
    public PlayerDTO levelUp(UUID id) {
        ...
        if (player.getExperience() < player.getExperienceStep()) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "You don't have enough experience to level up");
        }
    ...
    public PlayerDTO addMonster(UUID id, String monsterId) {
    ...
    public PlayerDTO removeMonster(UUID id, String monsterId) {
        Player player = getPlayerOrCreate(id);
    ...
    public PlayerDTO getPlayerWithMonsters(UUID id) {
        return new PlayerDTO(getPlayerOrCreate(id));
    }
}
