        ...
        <>
                ...
                <div className="relative">
                    ...
                    >
                        ...
                        <div className="relative h-80 w-56 perspective-1000">
                            ...
                            >
                                <div
                                    className="h-full w-full rounded-r-2xl border-4 border-l-2 border-white/30 bg-linear-to-br from-purple-700 via-pink-700 to-red-700 p-6 backdrop-blur-sm shadow-2xl">
                                    <div className="flex h-full flex-col items-center justify-center">
                            ...
                            <div
                                ...
                                <div
                                    className="absolute inset-0 rounded-2xl bg-linear-to-br from-purple-700 via-pink-700 to-red-700 border-4 border-white/30 backdrop-blur-sm shadow-2xl">
                                    {/* Shine effect */}
                                    <div
                                        className="absolute inset-0 rounded-2xl bg-linear-to-tr from-transparent via-white/20 to-transparent opacity-0 transition-opacity group-hover:opacity-100"/>
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                                        ...
                                        {/* Rarity indicator */}
                                        <div
                                            className="absolute bottom-4 left-4 right-4 rounded-lg bg-black/30 px-3 py-2 text-center backdrop-blur-sm">
                                    ...
                                    {/* Glow effect */}
                                    <div
                                        className={`absolute -inset-2 -z-10 rounded-2xl bg-linear-to-br from-purple-500 via-pink-500 to-red-500 blur-xl transition-opacity ${
            ...
            {isRevealing && revealedMonster && createPortal(
                ...
                >
                    ...
                    {/* Monster Card - Centré et agrandi */}
                    <div
                        ...
                        <div
                            className="transform scale-110 transition-transform duration-500 hover:scale-115 shadow-2xl rounded-xl">
